...
- Observation space: 15-dim obs + 3-dim goal.
- Action space:      5-dim, each element in [-1, 1], corresponding to target angles for joints 1, 2, 3, 4, 5

See _get_obs() and UR5eEnvs._convert_action() for details.
"""
class UR5ePushHard(UR5eEnvs):
    def _get_xml_path(self):
        return os.path.join(os.path.dirname(os.path.realpath(__file__)), '..', 'assets', "ur5e_push_hard.xml")
