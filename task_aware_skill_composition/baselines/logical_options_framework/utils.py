...
from task_aware_skill_composition.baselines.logical_options_framework.train import partition, load_logical_options
...
def get_logical_option_run_ids(task_name, seed):
    ...
    lo_run_ids_dict = {
        ...
        ("SimpleMazeTwoSubgoals", 0): ["54121566101c41d1b368ebebb10eaf5e", "f75545746a8f492f8a4008b1f408e771"],
