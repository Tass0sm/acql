...
class Skate(GoalConditionedEnv):
    ...
    def __init__(
        ...
        path = epath.resource_path('task_aware_skill_composition') / 'brax/envs/assets/skate.xml'
    ...
    def reset(self, rng: jax.Array) -> State:
        ...
        low = jp.array([-self._reset_noise_scale] * 3 + [-jp.pi])
        hi = jp.array([self._reset_noise_scale] * 3 + [jp.pi])
