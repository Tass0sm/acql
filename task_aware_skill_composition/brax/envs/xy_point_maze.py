...
def make_maze(maze_layout_name, maze_size_scaling):
    ...
    xml_path = epath.resource_path('task_aware_skill_composition') / 'brax/envs/assets/xy_point_maze.xml'
...
class XYPointMaze(PipelineEnv):
    ...
    def _get_obs(self, pipeline_state: base.State) -> jax.Array:
        """Observe point body position and velocities."""
