...
from task_aware_skill_composition.brax.agents.dqn import losses as dqn_losses
from task_aware_skill_composition.brax.agents.dqn import networks as dq_networks
...
def train(
    ...
    logdir = './logs',
    network_factory: types.NetworkFactory[dq_networks.DQNetworks] = dq_networks.make_dq_networks,
  ...
  make_policy = dq_networks.make_inference_fn(dq_network)
  ...
  critic_loss = dqn_losses.make_critic_loss(
