...
class CarSequence(BraxTaskBase):
    def __init__(self, enable_gui: bool = True):
        ...
        super(CarSequence, self).__init__(8, 1000, enable_gui)
...
class CarCover(BraxTaskBase):
    def __init__(self, enable_gui: bool = True):
        ...
        super(CarCover, self).__init__(8, 1000, enable_gui)
...
class CarBranch(BraxTaskBase):
    def __init__(self, enable_gui: bool = True):
        ...
        super(CarBranch, self).__init__(4, 1000, enable_gui)
...
class CarLoop(BraxTaskBase):
    def __init__(self, enable_gui: bool = False):
        self.waypoints = ([-2, -2],
                          ...
                          [2, 2],
                          [2, -2])
        super(CarLoop, self).__init__(17, 2000, enable_gui)
...
class CarSignal(BraxTaskBase):
    def __init__(self, enable_gui: bool):
        ...
        super(CarSignal, self).__init__(self.until_time + 2, 2000, enable_gui)
