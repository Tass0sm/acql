...
def _init_training_state(
    ...
    ddpg_network: networks.DDPGNetworks,
...
class DDPG:
    ...
    def train_fn(
        ...
        network_factory: types.NetworkFactory[networks.DDPGNetworks] = networks.make_ddpg_networks
        ...
        make_policy = networks.make_inference_fn(ddpg_network)
        ...
        for eval_epoch_num in range(num_evals_after_init):
            ...
            if process_id == 0:
                if config.checkpoint_logdir:
                    ...
                    path = f"{config.checkpoint_logdir}_ddpg_{current_step}.pkl"
