...
def train(
  ...
  hdcq_network = network_factory(
      ...
      preprocess_cost_observations_fn=normalize_fn,
      hidden_layer_sizes=hidden_layer_sizes,
      hidden_cost_layer_sizes=hidden_cost_layer_sizes,
      options=options,
      use_sum_cost_critic=use_sum_cost_critic
  )
  make_policy = hdcq_networks.make_option_inference_fn(hdcq_network, safety_threshold)
  make_flat_policy = hdcq_networks.make_inference_fn(hdcq_network, safety_threshold)
