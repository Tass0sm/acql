...
class ArmEEFBinpickEasy(ArmEnvs):
    def _get_xml_path(self):
        return os.path.join(os.path.dirname(os.path.realpath(__file__)), '..', 'assets', "arm_eef_binpick_easy.xml")
    ...
    def _get_initial_goal(self, pipeline_state: base.State, rng):
        ...
        cube_goal_pos = jnp.array([0.17, 0.6, 0.03]) + jnp.array(
