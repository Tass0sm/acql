...
from acql.stl import get_safety_conditions
from acql.stl import fold_tree, fold_spot_formula
...
class AutomatonCostWrapper(Wrapper):
    ...
    def _compute_cost(self, timestep: Timestep, action: jax.Array, ntimestep: Timestep):
        """
    ...
    def reset(self, key: jax.Array, cache: RenderingCache | None = None) -> Timestep:
        ...
        cost = self._compute_cost(None, None, timestep)
    ...
    def step(self, timestep: Timestep, action: jax.Array) -> Timestep:
        ...
        cost = self._compute_cost(timestep, action, ntimestep)
